...
def generar_arbol(ventana, a, b, c, resultado):
    ...
    # Función para determinar el color de cada nodo según la lógica de la tabla de verdad
    def determine_colors(a, b, c):
        colors = {}
        
        # Colorear el nodo A
        colors["A"] = "green" if a else "black"
        
        # Colorear el nodo B según el valor de A
        if a:
            colors["B1 = 0"] = "black"
            colors["B1 = 1"] = "green"
            colors["B0 = 0"] = "black"
            ...
            colors["B0 = 0"] = "green" if not b else "black"
            colors["B0 = 1"] = "black"
            colors["B1 = 0"] = "black"
            colors["B1 = 1"] = "black"
        
        # Colorear el nodo C según el valor de A y B
        if a and b:
            ...
            colors["C1 = 1 (Salida=0)"] = "green"
            colors["C0 = 0 (Salida=0)"] = "black"
            colors["C2 = 0 (Salida=0)"] = "black"
            colors["C3 = 0 (Salida=0)"] = "black"
        else:  # not a and not b
            colors["C0 = 0 (Salida=0)"] = "green"
            colors["C1 = 1 (Salida=0)"] = "black"
            colors["C2 = 0 (Salida=0)"] = "black"
            colors["C3 = 0 (Salida=0)"] = "black"
